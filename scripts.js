...
$(document).ready(function() {
    var turnInstance = {
        ...
        resize: function() {
            ...
            // Ensure this element exists before applying styles
            if (!this.el.style) {
                console.error("Style not accessible for element ID:", this.el.id);
                return;
            }
        ...
        plugins: function() {
            if (this.el) {
                try {
                    ...
                    console.error("Turn.js initialization failed:", e);
                }
            }
    ...
    // Initialize the turn object with the flipbook ID
    turnInstance.init('flipbook');

    // Keydown event for page turning
